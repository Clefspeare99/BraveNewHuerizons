...
return {
	...
	ACTIONFAIL =
	{
        REPAIR =
        {
            WRONGPIECE = "Hmm, that's not right.",
        },
        BUILD =
        {
            MOUNTED = "Oh come on, I can totally reach that!",
            HASPET = "But I want more!",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "I guess that is too dangerous.",
			GENERIC = "I can't shave that!",
			NOBITS = "Nothing to see here, move along.",
		},
		STORE =
		{
			GENERIC = "It's full.",
			NOTALLOWED = "That is not where that belongs!",
			INUSE = "Tick tock tick tock",
		},
		RUMMAGE =
		{	
			GENERIC = "Nope, no can do.",
			INUSE = "Guess I have to wait.",
		},
		USEKLAUSSACKKEY =
        {
        	WRONGKEY = "That didn't fit.",
        	KLAUS = "I'm a bit busy mate!!",
        },
        COOK =
        {
            GENERIC = "How does do food?",
            INUSE = "I suppose I'll let you finish",
            TOOFAR = "Definitely can't reach that.",
        },
        GIVE =
        {
            GENERIC = "This doesn't belong here.",
            DEAD = "I don't think you have a use for this anymore.",
            SLEEPING = "What they don't know can't hurt them.",
            BUSY = "Any second now.",
            ABIGAILHEART = "Meh, I tried.",
            GHOSTHEART = "On second thought...",
            NOTGEM = "You're crazy!",
            WRONGGEM = "Wrong gem.",
            NOTSTAFF = "Don't think that'll work.",
            MUSHROOMFARM_NEEDSSHROOM = "A shroom would help here.",
            MUSHROOMFARM_NEEDSLOG = "How about a living log?",
            SLOTFULL = "Try another spot.",
            DUPLICATE = "Already learned.",
            NOTSCULPTABLE = "You can't save this one.",
            NOTATRIUMKEY = "That's not a key.",
            CANTSHADOWREVIVE = "Dead is dead.",
            WRONGSHADOWFORM = "Do you even puzzle?",
        },
        GIVETOPLAYER =
        {
            FULL = "You are all out of room!",
            DEAD = "I don't think you have a use for this anymore.",
            SLEEPING = "What they don't know can't hurt them.",
            BUSY = "Any second now.",
        },
        ...
        WRITE =
        {
            GENERIC = "Looks good to me.",
            INUSE = "I guess you can finish writing.",
        },
        DRAW =
        {
            NOIMAGE = "If only I knew what I was doing.",
        },
        CHANGEIN =
        {
            GENERIC = "Not right now.",
            BURNING = "Nope, not gonna happen.",
             INUSE = "Only one at a time.",
        },
        ATTUNE =
        {
            NOHEALTH = "Feeling a bit weak right now.",
        },
        MOUNT =
        {
            TARGETINCOMBAT = "Haha! Good luck!",
            INUSE = "I was gonna do that!",
        },        SADDLE =
        {
            TARGETINCOMBAT = "Maybe I should wait for it to calm down.",
        },
        TEACH =
        {
            --Recipes/Teacher
            KNOWN = "Already know that one.",
            CANTLEARN = "This seems to complicated at the moment.",

,            --MapRecorder/MapExplorer
            WRONGWORLD = "Something seems off here.",
        },
        WRAPBUNDLE =
        {
            EMPTY = "Can't wrap up thin air!",
        },
	},
	ACTIONFAIL_GENERIC = "Can't do that right now.",
	ANNOUNCE_DIG_DISEASE_WARNING = "Already looking 10 times better!",
	ANNOUNCE_PICK_DISEASE_WARNING = "Is that rotting?",
	ANNOUNCE_ADVENTUREFAIL = "That didn't go well.",
    ANNOUNCE_MOUNT_LOWHEALTH = "This poor creature ain't looking too good.",
	ANNOUNCE_BEES = "NOT THE BEEEEEEEEEEEEES!!!!",
	ANNOUNCE_BOOMERANG = "Here it comes...There it goes...Here it comes!",
	ANNOUNCE_CHARLIE = "Charlie?",
	ANNOUNCE_CHARLIE_ATTACK = "OW! Charlie bit me!",
	ANNOUNCE_COLD = "It seems a bit chilly out.",
	ANNOUNCE_HOT = "I love the heat!",
	ANNOUNCE_CRAFTING_FAIL = "Well I thought that would work.",
	ANNOUNCE_DEERCLOPS = "What is that?!",
	ANNOUNCE_CAVEIN = "Oh darn, not again.",
	ANNOUNCE_ANTLION_SINKHOLE = 
	{
		"Get to solid ground!",
		"A knew this was coming!",
		"I thought this was a myth.",
	},
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        "Here you go buddy.",
        "A tribute for the great Antlion!",
        "That'll work for now, I hope.",
	},
	ANNOUNCE_SACREDCHEST_YES = "Pshh, of couse I'm worthy!",
	ANNOUNCE_SACREDCHEST_NO = "Oh crap.",
	ANNOUNCE_DUSK = "It's already this late?",
	ANNOUNCE_EAT =
	{
		GENERIC = "Delicious!",
		PAINFUL = "That didn't go down right.",
		SPOILED = "EWWWWWWWWWWW!",
		STALE = "That wasn't fresh.",
		INVALID = "I don't think that is edible.",
		YUCKY = "How do you call this food?!",
	},
    ANNOUNCE_ENCUMBERED =
    {
        "Oofff...",
        "I'll just let the machines do the heavy lifting next time...",
    ...
    ANNOUNCE_RUINS_RESET = "Back to square one!",
    ANNOUNCE_SNARED = "So sharp!",
    ANNOUNCE_REPELLED = "It's shielded!",
	ANNOUNCE_ENTER_DARK = "Why turned out the lights?",
	ANNOUNCE_ENTER_LIGHT = "The light has returned!",
	ANNOUNCE_FREEDOM = "Freedom! At long last!",
	ANNOUNCE_HIGHRESEARCH = "I'm the smartest!",
	ANNOUNCE_HOUNDS = "Wolves? No...HOUNDS!",
	ANNOUNCE_WORMS = "Underground now too?",
	ANNOUNCE_HUNGRY = "I'm starving!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Still fresh, we must be close.",
	ANNOUNCE_HUNT_LOST_TRAIL = "Dang, we were so close.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "Ground's too wet.",
	ANNOUNCE_INV_FULL = "I can take one more! Nope, never mind.",
	ANNOUNCE_KNOCKEDOUT = "Not again.",
	ANNOUNCE_LOWRESEARCH = "That doesn't help much.",
	ANNOUNCE_MOSQUITOS = "I swear I taste terrible!",
    ANNOUNCE_NOWARDROBEONFIRE = "You expect me to put that on while it's still burning?!",
    ANNOUNCE_NODANGERGIFT = "I don't want to make the monsters jealous!",
    ANNOUNCE_NOMOUNTEDGIFT = "I should get to solid ground first.",
	ANNOUNCE_NODANGERSLEEP = "Nope, too dangerous right now.",
	ANNOUNCE_NODAYSLEEP = "It's too bright out.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I can go a while longer.",
	ANNOUNCE_NOHUNGERSLEEP = "I need some food first.",
	ANNOUNCE_NOSLEEPONFIRE = "That would be a bit hot even for my taste.",
	ANNOUNCE_NODANGERSIESTA = "Not happening right now!",
	ANNOUNCE_NONIGHTSIESTA = "It's sleepy time silly.",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "There has to be a nicer area for this.",
	ANNOUNCE_NOHUNGERSIESTA = "Food first, siesta second.",
	ANNOUNCE_NODANGERAFK = "Can't get out of this one.",
	ANNOUNCE_NO_TRAP = "That was easy.",
	ANNOUNCE_PECKED = "Ow! Stop that!",
	ANNOUNCE_QUAKE = "That could be an issue.",
	ANNOUNCE_RESEARCH = "There is so much more out there to learn!",
	ANNOUNCE_SHELTER = "Thanks for the cover.",
	ANNOUNCE_THORNS = "Ow! Spikey!",
	ANNOUNCE_BURNT = "Let's not do that again.",
	ANNOUNCE_TORCH_OUT = "Well that was inevitable",
	ANNOUNCE_THURIBLE_OUT = "Yeah, that's gone.",
	ANNOUNCE_FAN_OUT = "Oh darn, it's out.",
    ANNOUNCE_COMPASS_OUT = "Jack Sparrow lied to me.",
	ANNOUNCE_TRAP_WENT_OFF = "That wasn't me...",
	ANNOUNCE_UNIMPLEMENTED = "Hmmm, not quite ready yet.",
	ANNOUNCE_WORMHOLE = "That's not how space works.",
	ANNOUNCE_TOWNPORTALTELEPORT = "Okay who broke science?",
	ANNOUNCE_CANFIX = "I got this!",
	ANNOUNCE_ACCOMPLISHMENT = "Hey I did it!",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "Why is no one around when I do something cool...",	
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Still hungry? Wow.",
	ANNOUNCE_TOOL_SLIP = "So slippery!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "That was too close!",
	ANNOUNCE_TOADESCAPING = "What does a toad have to do?",
	ANNOUNCE_TOADESCAPED = "Well dang it.",

	ANNOUNCE_DAMP = "Nice and wet.",
	ANNOUNCE_WET = "This feels nice.",
	ANNOUNCE_WETTER = "More water!",
	ANNOUNCE_SOAKED = "Yes, this is how it's meant to be!",
	
	ANNOUNCE_BECOMEGHOST = "I can't feel my legs! Oh...",
	ANNOUNCE_GHOSTDRAIN = "Well there it goes...",
	ANNOUNCE_PETRIFED_TREES = "The trees are talking to me?",
	ANNOUNCE_KLAUS_ENRAGE = "Now that is just too much for me.",
	ANNOUNCE_KLAUS_UNCHAINED = "It's unchained itself!",
	ANNOUNCE_KLAUS_CALLFORHELP = "No fair, this was a 1v1!",
	...
	BATTLECRY =
	{
		GENERIC = "Aim for the weak points!",
		PIG = "Bacon time!",
		PREY = "You're going down!",
		SPIDER = "Who needs this many legs?!",
		SPIDER_WARRIOR = "It's go time!",
		DEER = "Oh de-de-de-deer!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "He won't come back any time soon!",
		PIG = "You are free, for now.",
		PREY = "Get back here! Dang it.",
		SPIDER = "Next time buddy.",
		SPIDER_WARRIOR = "Get out of here!",
	},
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "This shouldn't work, but I'll take it.",
		ANTLION = 
		{
			GENERIC = "What do you want?",
			VERYHAPPY = "Nice, I can work with this.",
			UNHAPPY = "I think I messed up.",
		},
		ANTLIONTRINKET = "I suppose someone could want this?",
		SANDSPIKE = "That could have been a lot worse.",
        SANDBLOCK = "Kind of gritty!",
        GLASSSPIKE = "Good times, good times.",
        GLASSBLOCK = "Science!.",
		ABIGAIL_FLOWER = 
		{ 
			GENERIC ="It's nice, in a ghostly sort of way.",
			LONG = "What is so disturbing about this?",
			MEDIUM = "Getting the heebie-jeebies.",
			SOON = "Something is a bit off here.",
			HAUNTED_POCKET = "Hmmm, this could be bad in the long run...",
			HAUNTED_GROUND = "Ohh, what does this doe?",
		},

		BALLOONS_EMPTY = "Not as impressive empty.",
		BALLOON = "Where did we find helium?",

		BERNIE_INACTIVE =
		{
			BROKEN = "Well that was expected eventually.",
			GENERIC = "A bit scorched.",
		},

		BERNIE_ACTIVE = "Should that be moving?",
		
		BOOK_BIRDS = "Meh, I'll just wing it.",
		BOOK_TENTACLES = "I hear this one clings to you.",
		BOOK_GARDENING = "Learning how to make plants from plants.",
		BOOK_SLEEP = "Who needs to learn how to sleep?",
		BOOK_BRIMSTONE = "Oh so that is what Shrek was talking about, awful smell!",

        PLAYER =
        {
            GENERIC = "Heyo, %s!",
            ATTACKER = "%s looks dangerous.",
            MURDERER = "You murderer!",
            REVIVER = "%s, friend of the dead!",
            GHOST = "%s could really use a heart.",
            FIRESTARTER = "Why must you burn everything, %s!?",
        },
		WILSON = 
		{
			GENERIC = "I swear I know someone that looks just like you, %s!",
			...
			GHOST = "Better concoct a revival device. Can't leave a man of science floating.",
